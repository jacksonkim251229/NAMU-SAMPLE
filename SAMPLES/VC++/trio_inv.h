...
{
	char shrn_iscd[8];	char _shrn_iscd;                          //종목코드             
	char prpr_nmix[5];	char _prpr_nmix;                          //현물지수             
	char prdy_vrss_sign[1];	char _prdy_vrss_sign;                     //전일비부호           
	char futs_prdy_vrss[5];	char _futs_prdy_vrss;                     //전일비               
	char futs_oprc[5];	char _futs_oprc;                          //시가                 
	char futs_hgpr[5];	char _futs_hgpr;                          //고가                 
	char futs_lwpr[5];	char _futs_lwpr;                          //저가                 
	char acml_vol[12];	char _acml_vol;                           //거래량               
...
typedef struct tagIVWFUTREQ08Out2    //IVWFUTREQ08OutSMaster
{
	...
	char futs_prdy_vrss[5];	char _futs_prdy_vrss;                     //전일비               
	char futs_prdy_ctrt[5];	char _futs_prdy_ctrt;                     //등락률               
	char futs_oprc[6];	char _futs_oprc;                          //시가                 
	char futs_hgpr[6];	char _futs_hgpr;                          //고가                 
	char futs_lwpr[6];	char _futs_lwpr;                          //저가                 
	char acml_vol[12];	char _acml_vol;                           //거래량               
	...
	char dynmc_uplmtprc[6];	char _dynmc_uplmtprc;                     //실시간상한가         
	char dynmc_lwlmtprc[6];	char _dynmc_lwlmtprc;                     //실시간하한가         
...
typedef struct tagIVWFUTREQ08Out3    //코스피선물Master1
{
	...
	char futs_prpr[5];	char _futs_prpr;                          //현재가               
	char prdy_vrss_sign[1];	char _prdy_vrss_sign;                     //전일대비부호         
	char futs_prdy_vrss[5];	char _futs_prdy_vrss;                     //전일대비             
	char futs_prdy_ctrt[5];	char _futs_prdy_ctrt;                     //등락률               
	char mrkt_basis[5];	char _mrkt_basis;                         //베이시스             
	char hts_thpr[5];	char _hts_thpr;                           //이론가               
	char fugrate[5];	char _fugrate;                            //괴리도               
	char fugratio[5];	char _fugratio;                           //괴리율               
	...
	char futs_hgpr[5];	char _futs_hgpr;                          //고가                 
	char futs_lwpr[5];	char _futs_lwpr;                          //저가                 
	char dynmc_uplmtprc[5];	char _dynmc_uplmtprc;                     //실시간상한가         
	char dynmc_lwlmtprc[5];	char _dynmc_lwlmtprc;                     //실시간하한가         
	char fudynpriceflag[1];	char _fudynpriceflag;                     //동적가격제한여부     
	char filler[30];	char _filler;                             //FILLER               
} TIVWFUTREQ08Out3;
...
typedef struct tagIVWFUTREQ08Out5    //코스피선물호가1
{
	char shrn_iscd[8];	char _shrn_iscd;                          //종목코드             
	char bsop_hour[8];	char _bsop_hour;                          //호가시간             
	char futs_askp1[5];	char _futs_askp1;                         //매도우선호가         
	char futs_askp2[5];	char _futs_askp2;                         //차선매도호가         
	char futs_askp3[5];	char _futs_askp3;                         //차차선매도호가       
	char futs_askp4[5];	char _futs_askp4;                         //4차선매도호가        
	char futs_askp5[5];	char _futs_askp5;                         //5차선매도호가        
	...
	char futs_bidp1[5];	char _futs_bidp1;                         //매수우선호가         
	char futs_bidp2[5];	char _futs_bidp2;                         //차선매수호가         
	char futs_bidp3[5];	char _futs_bidp3;                         //차차선매수호가       
	char futs_bidp4[5];	char _futs_bidp4;                         //4차선매수호가        
	char futs_bidp5[5];	char _futs_bidp5;                         //5차선매수호가        
...
typedef struct tagIVWFUOREQ03Out1    //종목마스타기본자료
{
	...
	char optn_prpr[5];	char _optn_prpr;                          //현재가               
	char prdy_vrss_sign[1];	char _prdy_vrss_sign;                     //등락부호             
	char optn_prdy_vrss[5];	char _optn_prdy_vrss;                     //등락폭               
	char prdy_ctrt[5];	char _prdy_ctrt;                          //등락률               
	char optn_oprc[5];	char _optn_oprc;                          //시가                 
	char optn_hgpr[5];	char _optn_hgpr;                          //고가                 
	char optn_lwpr[5];	char _optn_lwpr;                          //저가                 
	char hts_thpr[5];	char _hts_thpr;                           //이론가               
	char acml_vol[12];	char _acml_vol;                           //거래량               
	char acml_tr_pbmn[18];	char _acml_tr_pbmn;                       //누적거래대금(백만)   
	char opopenyak[12];	char _opopenyak;                          //미결제약정수량       
	char oppreopenyak[7];	char _oppreopenyak;                       //미결제약정전일       
	char oplisthdate[11];	char _oplisthdate;                        //상장후최고일         
	char oplistldate[11];	char _oplistldate;                        //상장후최저일         
	...
	char optn_mxpr[5];	char _optn_mxpr;                          //상한가               
	char optn_llam[5];	char _optn_llam;                          //하한가               
	char opgrate[5];	char _opgrate;                            //괴리도               
	...
	char bsop_hour[8];	char _bsop_hour;                          //호가시간             
	char optn_askp1[5];	char _optn_askp1;                         //매도최우선호가       
	char optn_askp2[5];	char _optn_askp2;                         //매도차선호가         
	char optn_askp3[5];	char _optn_askp3;                         //매도차차선호가       
	char optn_askp4[5];	char _optn_askp4;                         //매도4차선호가        
	char optn_askp5[5];	char _optn_askp5;                         //매도5차선호가        
	char optn_bidp1[5];	char _optn_bidp1;                         //매수최우선호가       
	char optn_bidp2[5];	char _optn_bidp2;                         //매수차선호가         
	char optn_bidp3[5];	char _optn_bidp3;                         //매수차차선호가       
	char optn_bidp4[5];	char _optn_bidp4;                         //매수4차선호가        
	char optn_bidp5[5];	char _optn_bidp5;                         //매수5차선호가        
	char askp_rsqn1[12];	char _askp_rsqn1;                         //매도최우선잔량       
	char askp_rsqn2[12];	char _askp_rsqn2;                         //매도차선잔량         
	char askp_rsqn3[12];	char _askp_rsqn3;                         //매도차차선잔량       
	char askp_rsqn4[12];	char _askp_rsqn4;                         //매도4차선잔량        
	...
	char opgratio[5];	char _opgratio;                           //괴리율               
	char optn_prdy_clpr[5];	char _optn_prdy_clpr;                     //전일종가             
	char dynmc_uplmtprc[5];	char _dynmc_uplmtprc;                     //실시간상한가         
	char dynmc_lwlmtprc[5];	char _dynmc_lwlmtprc;                     //실시간하한가         
	char fudynpriceflag[1];	char _fudynpriceflag;                     //동적가격제한여부     
	...
	char prc_lmt_mx_step[2];	char _prc_lmt_mx_step;                    //가격제한확대상한단계 
	char prc_lmt_ll_step[2];	char _prc_lmt_ll_step;                    //가격제한확대하한단계 
	char optn_sdpr[5];	char _optn_sdpr;                          //기준가               
	char filler[30];	char _filler;                             //FILLER               
} TIVWFUOREQ03Out1;
...
typedef struct tagIVWFUOREQ03Out2    //코스피200지수
{
	...
	char prpr_nmix[5];	char _prpr_nmix;                          //코스피200지수        
	char prdy_vrss_sign[1];	char _prdy_vrss_sign;                     //코스피200등락부호    
...
typedef struct tagIVWFUOREQ03Out3    //옵션변동거래량자료, [반복]
{
	...
	char prdy_vrss_sign[1];	char _prdy_vrss_sign;                     //등락부호             
	char optn_prdy_vrss[5];	char _optn_prdy_vrss;                     //등락폭               
	char optn_askp[5];	char _optn_askp;                          //매도호가             
	char optn_bidp[5];	char _optn_bidp;                          //매수호가             
	char cnqn[12];	char _cnqn;                               //거래량               
	char acml_vol[12];	char _acml_vol;                           //누적거래량           
...
typedef struct tagIVWFUOREQ03Out4    //선물최근월물
{
	...
	char futs_askp1[5];	char _futs_askp1;                         //선물최근월물매도최우선호가 
	char futs_askp2[5];	char _futs_askp2;                         //선물최근월물매도차선호가 
	char futs_askp3[5];	char _futs_askp3;                         //선물최근월물매도차차선호가 
	char futs_askp4[5];	char _futs_askp4;                         //선물최근월물매도4차선호가 
	char futs_askp5[5];	char _futs_askp5;                         //선물최근월물매도5차선호가 
	char futs_bidp1[5];	char _futs_bidp1;                         //선물최근월물매수최우선호가 
	char futs_bidp2[5];	char _futs_bidp2;                         //선물최근월물매수차선호가 
	char futs_bidp3[5];	char _futs_bidp3;                         //선물최근월물매수차차선호가 
	char futs_bidp4[5];	char _futs_bidp4;                         //선물최근월물매수4차선호가 
	char futs_bidp5[5];	char _futs_bidp5;                         //선물최근월물매수5차선호가 
...
typedef struct tagIVWFUOREQ03Out5    //선물변동거래량자료, [반복]
{
	...
	char futs_prpr[5];	char _futs_prpr;                          //현재가               
	char prdy_vrss_sign[1];	char _prdy_vrss_sign;                     //등락부호             
	char futs_prdy_vrss[5];	char _futs_prdy_vrss;                     //등락폭               
	char futs_askp[5];	char _futs_askp;                          //매도호가             
	char futs_bidp[5];	char _futs_bidp;                          //매수호가             
	char cnqn[12];	char _cnqn;                               //거래량               
	char acml_vol[12];	char _acml_vol;                           //누적거래량           
	char ojopenyak[12];	char _ojopenyak;                          //미결제약정           
	char filler[30];	char _filler;                             //FILLER               
